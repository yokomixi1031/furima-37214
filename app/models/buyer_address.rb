class BuyerAddress
  ...
  def save
    ...
    Address.create(postal_code: postal_code, ship_from_area_id: ship_from_area_id, municipalities: municipalities, address: address, building_name: building_name, telephone: telephone, buyer_id: buyer.id)
  end
end